...
global.owner = process.env.OWNER_NUMBER  || '6281214552942' ;  // ADD YOUR NUMBER WITHOUT +
...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://i.postimg.cc/s2SQvLVv/IMG-20240505-101623.jpg' ;
//=================================================================================
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '12_05_2024_SIGMA_MD_Rk1EBwMF_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
